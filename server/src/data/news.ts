...
本作は、ファントムキャットが警察の追跡をかいくぐりながら街を駆け抜ける
スリリングな非対称対戦ゲームです。

## 開発チーム

少人数のインディーチームで開発を進めています。

今後もXアカウント（@phantomcatworks）で最新情報をお届けします！`,
  },
  {
    slug: "dev-log-01",
...
赤いマントをまとった謎の黒猫。夜の街を自在に駆け抜けます。
緑の瞳が闇の中で光り、その正体を誰も知らない——。

## 警察キャラクター

街の秩序を守るため、ファントムキャットを追跡します。
チームワークで包囲網を張り巡らせましょう。
